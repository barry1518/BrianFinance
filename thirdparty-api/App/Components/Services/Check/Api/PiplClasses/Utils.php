...
class Utils extends Service {
    ...
    public static $piplapi_countries = [
     ...
     * @return array
     */
    public static function piplapi_date_parse_from_format(string $format, string $date):array {

        $returnArray = ['hour' => 0, 'minute' => 0, 'second' => 0,
            'month' => 0, 'day' => 0, 'year' => 0];

        $dateArray = [];

        // array of valid date codes with keys for the return array as the values
        $validDateTimeCode = ['Y' => 'year', 'y' => 'year',
            'm' => 'month', 'n' => 'month',
            'd' => 'day', 'j' => 'day',
            'H' => 'hour', 'G' => 'hour',
            'i' => 'minute', 's' => 'second'];
     ...
     * @param array $parsed
     */
    public static function validate_datetime(array $parsed){
     ...
     */
    public static function piplapi_str_to_datetime(string $s): \DateTime {
     ...
     */
    public static function piplapi_datetime_to_str(\DateTime $dt):string {
     ...
     */
    public static function piplapi_str_to_date(string $s): \DateTime {
     ...
     */
    public static function piplapi_date_to_str(\DateTime $d):string {
     ...
     */
    public static function piplapi_is_valid_url(string $url):bool {
     ...
     */
    public static function piplapi_alpha_chars(string $s):string {
     ...
     */
    public static function piplapi_alnum_chars(string $s):string {
     ...
     */
    public static function piplapi_string_startswith(string $str1, string $str2):bool {
